function Section4SignUp() {
  return (
    <section className="relative w-full  flex flex-col lg:flex-row mt-4">
      ...
      <div
        ...
        "
      >
        <h1 className="text-2xl md:text-4xl  mb-10 lg:mb-16">Single Sign On</h1>
